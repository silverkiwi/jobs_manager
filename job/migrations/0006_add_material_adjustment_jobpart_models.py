    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purchase_order_line', models.ForeignKey(blank=True, help_text='Convenience link to original PO line (derived via source_stock)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='material_entries', to='workflow.purchaseorderline')),
            ],
            options={
