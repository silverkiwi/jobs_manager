...
from accounts.views.token_view import CustomTokenObtainPairView
from django.urls import path
from django.contrib.auth import views as auth_views
from rest_framework_simplejwt.views import TokenRefreshView, TokenVerifyView
from accounts.views.password_views import SecurityPasswordChangeView
...
urlpatterns = [
    ...
    path('password_change/', SecurityPasswordChangeView.as_view(), name='password_change'),
