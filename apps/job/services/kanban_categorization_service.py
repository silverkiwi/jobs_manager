...
class KanbanCategorizationService:
    ...
    COLUMN_STRUCTURE = {
        'draft': KanbanColumn(
            ...
            column_title='Draft',
            sub_categories=[
                KanbanSubCategory('quoting', 'Quoting', 'bg-yellow-500')
            ],
            color_theme='yellow'
        ),
        ...
        'on_hold': KanbanColumn(
            ...
            sub_categories=[
                KanbanSubCategory('awaiting_materials', 'Awaiting Materials', 'bg-orange-500'),
                KanbanSubCategory('awaiting_staff', 'Awaiting Staff', 'bg-purple-500'),
                KanbanSubCategory('awaiting_site_availability', 'Awaiting Site', 'bg-indigo-500'),
        ...
        'recently_completed': KanbanColumn(
            ...
            sub_categories=[
                KanbanSubCategory('recently_completed', 'Just Finished', 'bg-emerald-500')
            ],
            color_theme='emerald'
        ),
