...
class WeeklyTimesheetService:
    ...
    @classmethod
    def get_weekly_overview(cls, start_date: date, export_to_ims: bool = False) -> Dict[str, Any]:
        """
    ...
    @classmethod
    def _get_week_days(cls, start_date: date, export_to_ims: bool = False) -> List[date]:
    ...
    @classmethod
    def _get_staff_data(cls, week_days: List[date], export_to_ims: bool = False) -> List[Dict[str, Any]]:
        ...
        for staff_member in staff_members:
            ...
            for day in week_days:
                ...
                if export_to_ims:
                    ...
                    total_time_and_half_hours += daily_data.get('time_and_half_hours', 0)
    ...
    def _get_daily_data(cls, staff_member: Staff, day: date) -> Dict[str, Any]:
        ...
        try:
            ...
            billable_hours = sum(entry.hours for entry in time_entries if entry.is_billable)
            ...
            leave_type = leave_entries.first().job_pricing.job.name if has_leave else None
    ...
    @classmethod
    def _get_day_status(cls, daily_hours: float, scheduled_hours: float, has_leave: bool) -> str:
    ...
    @classmethod
    def _calculate_weekly_totals(cls, staff_data: List[Dict[str, Any]]) -> Dict[str, Any]:
        """Calculate weekly totals from staff data."""
        total_hours = sum(staff['total_hours'] for staff in staff_data)
        total_billable_hours = sum(staff['total_billable_hours'] for staff in staff_data)
    ...
    @classmethod
    def _calculate_summary_stats(cls, staff_data: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    @classmethod
    def submit_paid_absence(cls, staff_id: str, start_date: date, end_date: date, 
                          leave_type: str, hours_per_day: float, description: str = '') -> Dict[str, Any]:
