document.addEventListener('DOMContentLoaded', function() {
    ...
    function processQuoteFile(formData) {
        ...
        document.querySelector('.container-fluid').appendChild(loadingIndicator);
          // Submit the form
        console.log('Sending fetch request to /purchasing/api/supplier-quotes/extract/');
        ...
        .then(response => {
            ...
            if (response.redirected) {
                ...
                return response.json().then(data => {
                    ...
                    if (data.success) {
                        window.location.href = '/purchasing/purchase-orders/new/?quote_data=' + encodeURIComponent(JSON.stringify(data.data));
                    } else {
