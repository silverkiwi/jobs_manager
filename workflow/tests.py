...
class JobApiTests(TestCase):
    def setUp(self):
        ...
        self.client = Client()
        login_successful = self.client.login(email='corrin+testing@morrissheetmetal.co.nz', password=os.getenv('DB_PASSWORD','abcde'))
    ...
    def test_get_job_api_not_found(self):
        ...
        response = self.client.get(reverse('get_job_api'), {'job_id': 'non-existent-id'})
