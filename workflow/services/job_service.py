...
def get_job_with_pricings(job_id):
    ...
    pricing_stages = ["latest_estimate_pricing", "latest_quote_pricing", "latest_reality_pricing"]

    # Prefetch list to store all prefetch operations
    prefetch_list = []

    # Loop through each pricing stage to create Prefetch objects for time, material, and adjustment entries
