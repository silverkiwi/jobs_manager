...
class StaffAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Personal Info', {'fields': ('first_name', 'last_name', 'pay_rate', 'ims_payroll_id')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'first_name', 'last_name', 'pay_rate', 'ims_payroll_id', 'password1', 'password2', 'is_staff', 'is_active')}
        ),
    )
    search_fields = ('email',)
    ordering = ('email',)
