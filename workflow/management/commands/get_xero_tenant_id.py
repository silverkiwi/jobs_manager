...
from workflow.api.xero.xero import api_client, get_valid_token
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not token:
            self.stdout.write(self.style.ERROR('No valid Xero token found. Please authenticate with Xero first.'))
            return
