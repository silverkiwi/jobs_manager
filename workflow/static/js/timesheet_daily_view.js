    document.addEventListener('DOMContentLoaded', function() {
        const gridOptions = {
            columnDefs: [
                ...
                { headerName: 'Hours Worked', field: 'hours_worked', editable: true, type: 'numericColumn' },
                { headerName: 'Billable', field: 'billable', editable: true, cellRenderer: 'agCheckboxRenderer' }
            ],
            defaultColDef: {
                flex: 1,
                minWidth: 100,
        ...
        function loadDailyViewData(gridApi) {
            ...
            fetch(url)
                ...
                .catch(error => console.error('Error loading daily timesheet data:', error));
        }
    });
