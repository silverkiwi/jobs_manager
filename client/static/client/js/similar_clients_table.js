function initializeSimilarClientsTable() {
  ...
  const accountCustomerInput = document.querySelector(
    'input[name="is_account_customer"]',
  );
  const xeroContactIdInput = document.querySelector(
    'input[name="xero_contact_id"]',
  );
  ...
  form.addEventListener("submit", function (e) {
    if (window.selectedClientId) {
      console.log(
        "Form submitted with selectedClientId:",
      ...
      console.log(
        "Form submitted without selectedClientId - proceeding with normal submission",
      );
    }
  });
